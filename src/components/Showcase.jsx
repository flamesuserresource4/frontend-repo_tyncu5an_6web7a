...
const projects = [
  {
    tag: 'E-Commerce',
    title: 'Skincare D2C Launch',
    result: '+2.4x ROAS',
  },
  {
    tag: 'B2B SaaS',
    title: 'Website Relaunch & SEO',
    result: '+120% Org. Traffic',
  },
  {
    tag: 'Brand',
    title: 'Content Kampagnen Q4',
    result: '+65% CTR',
  },
]
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {projects.map((p, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative overflow-hidden rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-6 backdrop-blur"
            >
